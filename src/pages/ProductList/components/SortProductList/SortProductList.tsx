            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center">
                    ...
                    <div className="ml-2 flex">
                        {page === 1 ? (
                            <span className="flex justify-center items-center w-9 px-3 h-8 rounded-tl-sm rounded-bl-sm bg-white/60 hover:bg-slate-100 cursor-not-allowed shadow">
                                {" "}
                                <svg
                            ...
                            <Link
                                ...
                                className="flex justify-center items-center w-9 px-3 h-8 rounded-tl-sm rounded-bl-sm bg-white hover:bg-slate-100 shadow"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
